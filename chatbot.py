...
def main():
    ...
    # Home Menu
    if choice == "Home":
        st.write("Welcome to the chatbot. Please type a message and press Enter or click the Send button to start the conversation.")
        ...
        # Add a button for sending the input
